...
# -------------------------------------------------------------------------
NUM_GPU=0.14     # 每个 Trial 占用的 GPU 份额
CUDA_A="0,3"       # 🎯 流水线 A 绑定的 GPU 卡号 (负责跑无 Focal 托底的经典基线组)
...
(
    ...
    python main.py --mode tune --task train_y --model TARNET --version y_v8_s4_v10_all_mix_original_code_search_head_wd_alpha_same --exp_name y_v8_s4_v10_all_mix_original_code_search_head_wd_alpha_same --cuda $CUDA_A --num_per_gpu $NUM_GPU # > $LOG_DIR/log_y_ours_s4_conflict_0710_search_alpha_res_2_search_head.txt 2>&1
